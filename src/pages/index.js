    ...
    <>
      ...
      >
        ...
        >
            ...
            <div className={"text-left text-lg lg:w-[50%] text-[14px]"}>
              ...
              >
                ...
                <div className="flex flex-row justify-between ">
                  ...
                  <div className={'h-[45px] w-[38%] mt-4 bg-[#D1E3FF] bg-opacity-[0.39] p-1.5 border-2 border-solid border-[#9BB0D3] rounded-[100px] text-center text-[14px] font-semibold'}>
                    7.6%
                  </div>
              ...
              >
                ...
                >
                  <div
                    className={
                      "flex justify-center items-center text-white font-semibold rounded-[35px]  w-[242px] h-[48px]   shadow-lg shadow-[#36b3665d] bg-[#00d382] text-[16px]"
                    }
                    onClick={calculate}
                  >
                    Calculate
          ...
          <div
            className={
              " max-h-[376px]  xl:w-[23%] px-[20px] py-[22px] max-xl:mt-[30px]  border-2 border-white rounded-[30px] shadow-md shadow-[#505C6227] bg-white bg-opacity-40 backdrop-blur-[30px] overflow-y-scroll text-[14px]"
            }
          >
        ...
        >
          ...
          />
            ...
            content={
              <>
              <ul>
                <li className=" flex flex-row "><VscCircleFilled className=" text-[#00DD6F] mt-[2px] relative flex-shrink-0 "/>Deduction under Section 80C: The deposit made into an SSY account is eligible for a tax deduction under Section 80C of the Income Tax Act, up to a limit of ₹1.5 lakh per financial year.</li>
                <li className=" flex flex-row "><VscCircleFilled className=" text-[#00DD6F] mt-[2px] relative flex-shrink-0"/>Tax-free interest: The interest earned on the deposit in an SSY account is exempt from tax.</li>
