...
export default function Home() {
  ...
  const [point,setPoint]=useState([totalInvestment,totalInterest]);
  ...
  function calculate() {
    ...
    setPoint([totalInvestment,totalInterest]);
  }
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* Calculator */}
            <div className={"text-left text-lg w-[60%] "}>
              {/* Input box wrapper */}
              <div
                className={
              ...
              >
                ...
                <div className="flex flex-row justify-between ">
                  ...
                  <div className={' mt-4 w-[150px] h-[40px] bg-[#D1E3FF] bg-opacity-[0.39] border-2 border-solid border-[#9BB0D3] rounded-[100px] text-center font-semibold p-1'}>
                    7.6%
                  </div>
          ...
          >
            ...
            <CollapsibleBox
              ...
              content={
                <div className={styles.answer}><table><tr><th>Financial Year</th><th>Interest Rate</th></tr>
        ...
        >
          <CollapsibleBox
            ...
            content={
              <>
              <div>Sukanya Samriddhi Yojana (SSY) is a government-sponsored savings scheme in India for the girl child. It is a long-term investment option that offers attractive interest rates and tax benefits.
</div>
<br/>
          ...
          />
            ...
            content={
              <>
              <ul>
                <li>Deduction under Section 80C: The deposit made into an SSY account is eligible for a tax deduction under Section 80C of the Income Tax Act, up to a limit of ₹1.5 lakh per financial year.</li>
                <li>Tax-free interest: The interest earned on the deposit in an SSY account is exempt from tax.</li>
                <li>Exemption under Section 10(10D): The maturity amount received on the closure of the SSY account is exempt from tax under Section 10(10D) of the Income Tax Act.</li>
              </ul>
              </>}
          />
